...
//            snackbar.setAction("Dismiss", view -> snackbar.dismiss()).show();
            ...
            progressText.setText(Global.greetings_progress + "/10"); // TODO
        ...
        mic1.setOnClickListener(view -> {
            ...
            speech.startListening("greetings", phrases[0], done1, progressText);
        });
        mic2.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[1], done2, progressText);
        });
        mic3.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[2], done3, progressText);
        });
        mic4.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[3], done4, progressText);
        });
        mic5.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[4], done5, progressText);
        });
        mic6.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[5], done6, progressText);
        });
        mic7.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[6], done7, progressText);
        });
        mic8.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[7], done8, progressText);
        });
        mic9.setOnClickListener(view -> {
            checkPermission();
            speech.stopListening();
            speech.startListening("greetings", phrases[8], done9, progressText);
        });
