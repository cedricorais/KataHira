...
public class GreetingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audio1.setOnClickListener(view -> {
            ...
            tts.speak("はい", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio2.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("いいえ", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio3.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("おねがいします", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio4.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("ありがとう", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio5.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("どういたしまして", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio6.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("すみません", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio7.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("ごめんなさい", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio8.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("わかりません", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio9.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("しりません", TextToSpeech.QUEUE_ADD, null, null);
        });
        audio10.setOnClickListener(view -> {
            Toast.makeText(this, getString(R.string.tts_playing), Toast.LENGTH_SHORT).show();
            tts.speak("ただいま", TextToSpeech.QUEUE_ADD, null, null);
        });
